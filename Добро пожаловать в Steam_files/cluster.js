...
Cluster.BuildClusterElements = function ( $ClusterCtn, rgMainCaps, strFeatureOverride )
{
	...
	for ( var i = 0; i < rgMainCaps.length; i++ )
	{
		...
		if ( oItem.recommended_by_curator )
			strStatus = 'Рекомендовано вашими кураторами';
		else if ( oItem.recommended )
			strStatus = 'Рекомендовано вам';
...
Cluster.BuildClusterCapsule = function( unAppID, unPackageID, strStatus, strFeature, nDepth, rgItemInfo )
{
	...
	{
		var $elWhyButton = $J ( '<span />' ).text ( rgItemInfo.recommended ? "\u041f\u043e\u0447\u0435\u043c\u0443?" : "\u041a\u0442\u043e?");
		$elWhyButton.click ( function ( event )
		{
			...
			} ).done ( function ( data )
			{
				...
				if ( data.curators )
				{
					strTooltipContent += '<div class="reasonheader">' +"\u0422\u043e\u0432\u0430\u0440\u044b, \u0440\u0435\u043a\u043e\u043c\u0435\u043d\u0434\u043e\u0432\u0430\u043d\u043d\u044b\u0435 \u0432\u0430\u0448\u0438\u043c\u0438 \u043a\u0443\u0440\u0430\u0442\u043e\u0440\u0430\u043c\u0438:" +'</div>';
				...
				if ( data.tags )
				{
					strTooltipContent += '<div class="reasonheader">' + "\u041c\u0435\u0442\u043a\u0438, \u043a\u043e\u0442\u043e\u0440\u044b\u0435 \u043c\u043e\u0433\u0443\u0442 \u0431\u044b\u0442\u044c \u0432\u0430\u043c \u0438\u043d\u0442\u0435\u0440\u0435\u0441\u043d\u044b:" +'</div>';
					for ( var i = 0; i < data.tags.length; i++ )
					{
						strTooltipContent += '<a href="https://store.steampowered.com/tag/ru/'+data.tags[ i ].name+'/">' + data.tags[ i ].name + '</a>';
					}
				}

				if ( !strTooltipContent )
					strTooltipContent = '<div class="reasonheader">' + "\u041d\u0435\u0434\u043e\u0441\u0442\u0430\u0442\u043e\u0447\u043d\u043e \u0434\u0430\u043d\u043d\u044b\u0445" + '</div>'
						+ '<div>' + "\u0418\u0433\u0440\u0430\u0439\u0442\u0435 \u0431\u043e\u043b\u044c\u0448\u0435, \u0447\u0442\u043e\u0431\u044b \u0440\u0435\u043a\u043e\u043c\u0435\u043d\u0434\u0430\u0446\u0438\u0438 \u0431\u044b\u043b\u0438 \u0442\u043e\u0447\u043d\u0435\u0435!" + '</div>';
